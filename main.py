...
8. THỤT ĐẦU DÒNG (INDENTATION): Nếu đoạn văn trong bản gốc có lùi vào ở dòng đầu tiên, BẮT BUỘC chèn cụm ký tự `&emsp;&emsp;` vào ngay vị trí bắt đầu của đoạn văn đó. TUYỆT ĐỐI KHÔNG dùng phím Space (dấu cách) hoặc phím Tab để lùi dòng vì sẽ gây lỗi định dạng.
