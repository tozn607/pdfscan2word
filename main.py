...
4. ĐỊNH DẠNG (CỰC KỲ QUAN TRỌNG): BẮT BUỘC quan sát kỹ và khôi phục chính xác các chữ **In đậm** và *In nghiêng* trong bản gốc. TUYỆT ĐỐI KHÔNG được bỏ sót định dạng của các tiêu đề hoặc các đoạn văn nhấn mạnh.
...
4. FORMATTING (CRUCIAL): YOU MUST carefully observe and restore exact **Bold** and *Italic* text from the original. ABSOLUTELY DO NOT miss the formatting of headings or emphasized paragraphs.
